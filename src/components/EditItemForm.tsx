    ...
    return (
        <>
            <div className="animate-fadeIn fixed inset-0 z-50 flex items-center justify-center bg-black/60">
                {showAlert && (
                    <SuccessAlert message={"Item Updated Successfully"} />
                )}
                <div className="bg-white rounded-3xl shadow-2xl p-8 w-full max-w-2xl relative animate-fadeInUp">
                    ...
                    {isLoading ? (
                        ...
                        <div className="py-16 text-center text-red-500">Failed to load item.</div>
                    ) : (
                        <form onSubmit={handleSubmit} className="space-y-6" encType="multipart/form-data">
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="flex-1">
                                    <label htmlFor="itemName" className="block text-[#2563eb] font-semibold mb-1">
                                ...
                                <div className="flex-1">
                                    <label htmlFor="serialNumber" className="block text-[#2563eb] font-semibold mb-1">
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="flex-1">
                                    <label htmlFor="itemType" className="block text-[#2563eb] font-semibold mb-1">
                                ...
                                <div className="flex-1">
                                    <label htmlFor="itemModel" className="block text-[#2563eb] font-semibold mb-1">
                            ...
                            <div className="flex flex-col md:flex-row gap-4">
                                <div className="flex-1">
                                    <label htmlFor="itemMake" className="block text-[#2563eb] font-semibold mb-1">
                                ...
                                <div className="flex-1">
                                    <label htmlFor="description" className="block text-[#2563eb] font-semibold mb-1">
